...
def random_crop_around_label(image, right_x, right_y, left_x, left_y, crop_size=32, max_offset=2):
    # 이미지 크기 확인
...
# 디렉토리 경로 설정
base_dir = '/Users/hong-eun-yeong/Codes/'
txt_dir = '0_filtered_labels'
blind_dir = '0_filtered_images'
# 새로운 폴더 경로 설정
